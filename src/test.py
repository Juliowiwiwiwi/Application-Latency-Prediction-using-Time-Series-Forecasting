...
LOOKBACK = 12          # 1 hour 12 x 5-min steps
...
#CHRONOLOGICAL SPLIT (before any scaling — avoids leakage)
...
# DERIVED CLASSIFICATION METRICS (threshold the regression output)
...
#LEAD-TIME VALIDATION AGAINST KNOWN FAILURES
